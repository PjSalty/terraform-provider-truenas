...
This directory holds individual changelog entries per merge request, managed
by [changie](https://changie.dev/). Each MR that changes user-visible behavior
...
multiple MRs land in parallel. Per-MR entry files avoid the conflicts entirely
