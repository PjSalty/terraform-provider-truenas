...
//
// This is the equivalent of per-resource `deletion_protection` flags
// found in major Terraform providers, except it operates at the client
// layer for EVERY resource in the provider at once, so there is no
// per-resource coverage gap and no schema surface to audit.
//
