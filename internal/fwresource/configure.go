...
// the pattern here mirrors hashicorp/terraform-provider-aws:internal/framework
// — future resources and review comments can point at ConfigureClient
// instead of copy-pasting the same ten lines.
package fwresource
