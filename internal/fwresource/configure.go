...
// type-assert *wsclient.Client, emit a diagnostic on mismatch. Extracting
...
// ConfigureClient performs the standard *wsclient.Client type assertion used
...
func ConfigureClient(req resource.ConfigureRequest, resp *resource.ConfigureResponse) (*wsclient.Client, bool) {
