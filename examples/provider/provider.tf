...
# configuration against production TrueNAS — the AWS provider
# `deletion_protection` equivalent, enforced at the wire for every
# resource in the provider at once. See docs/guides/phased-rollout.md.
#
# provider "truenas" {
#   url                = "https://prod.truenas.example.com"
#   api_key            = var.prod_api_key
